...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('/Writer/Create')}}">+ Account</a> || <a href="{{ url('/Task') }}">LIST Tasks</a> || <a href="{{ url('/Logout') }}">LogOut</a>
        <br>
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        <a href='{{ url('/Writer/delete/' . $value->id) }}' class='btn btn-danger m-r-1em'>{{trans('labels.delete')}}</a>



                        <a href="{{ url('/Writer/edit/' . $value->id) }}" class='btn btn-primary m-r-1em'>{{trans('labels.edit')}}</a>
                    </td>
                </tr>
            @endforeach
            <!-- end table -->
